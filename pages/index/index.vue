<template>
    <view class="content">
        ...
        >
            <swiper-item>
                <view class="swiper-item"><image src="/static/image/index/banner.png" mode="aspectFit"></image></view>
            </swiper-item>
        </swiper>
        <view class="cells">
            <view class="cells_hd m_flex_middle m_flex_justify">
                ...
                <view class="m_flex_middle">
                    <view class="addr_icon"><image src="/static/image/index/addr.png" mode="aspectFit"></image></view>
...
export default {
    ...
    data() {
        return {
            ...
            price: ['500以下', '500-700', '700-900', '900-1200', '1200-1500', '1500以上'],
